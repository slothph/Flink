...
/**
 * @author hao.peng01@hand-china.com 2020/12/23 19:59
 */
...
//        Table dataTable = tableEnv.fromDataStream(dataStream, "id,timestamp as ts,temperature as temp,pt.proctime ");
        ...
        //SQL
        Table resultSqlTable = tableEnv.sqlQuery("select id ,count(id) as cnt,avg(temp) as avgTemp," +
                "tumble_end(rt,interval '10' second) from sensor group by id,tumble(rt,interval '10' second)");
        //5.2 Over Window
        //table API
